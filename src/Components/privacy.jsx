...
export default function Privacy(){
    const [data, setData] = useState([
        {
          purpose: "To connect you with a dentist who will offer you an examination and check your suitability for treatment",
          dataTypes: ["(a)Identity" ,"(b)Contact"],
          lawfulBasis: ["Performance of a contract with you", "Necessary for our legitimate interests (to deliver products and services)"]
        },
        {
        ...
        },
        {
          ...
          dataTypes: ["Identity", "Contact", "Usage", "Marketing and Communications"],
          lawfulBasis: [
            "Performance of a contract with you",
        ...
        },
        {
          ...
          lawfulBasis: ["Necessary for our legitimate interests (to define types of customers for our products and services, to keep our website updated and relevant, to develop our business and to inform our marketing strategy)"]
        },
        {
          purpose: "To make suggestions and recommendations to you about goods or services that may be of interest to you",
          dataTypes: ["Identity", "Contact", "Technical", "Usage", "Marketing and Communications"],
          lawfulBasis: ["Necessary for our legitimate interests (to develop our products/services and grow our business)"]
        }
      ]);
    return(
        <>
...
Welcome to the Nomad Locum Limited's website privacy policy. 

                </p>
                <p>
                    
Nomad Locum Limited respects your privacy and is committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website (regardless of where you visit it from) and tell you about your privacy rights and how the law protects you. 
...
This privacy policy aims to give you information on how Nomad Locum Limited collects and processes your personal data through your use of this website, including any data you may provide through this website when you sign up to receive information about our services. 
                ...
                <p>
                Nomad Locum Limited is the controller and responsible for your personal data (collectively referred to as "Nomad Locum", "we", "us" or "our" in this privacy policy). 
                </p>
                <p>
               ...
               <h4>Contact details</h4>
                ...
                <p>
                Full name of legal entity: Nomad Locum Limited 
                </p>
                <p>
                Email address: info@nomadnurse.co.uk.
                </p>
                <p>
                Postal address: {"{TBC}"}
                </p>
                <br />
                <p>
                You have the right to make a complaint at any time to the Information Commissioner's Office (ICO), the UK regulator for data protection issues <Link to={"https://ico.org.uk/"}>(www.ico.org.uk)</Link>. We would, however, appreciate the chance to deal with your concerns before you approach the ICO so please contact us in the first instance. 
...
We keep our privacy policy under regular review. 
               ...
               <h3> 2. The data we collect about you</h3>
                ...
                <ul>
                    <li><p><strong>identitiy Data</strong> includes first name, maiden name, last name, username or similar identifier, information about your teeth as set out on our ‘Can You Treat Me’ page, title, date of birth and gender. </p></li>
                    <li><p><strong>Contact Data</strong> includes email address and phone number. </p>
</li>
                    ...
                    <li><p><strong> Marketing and Communications Data</strong> includes your preferences in receiving marketing from us and our third parties and your communication preferences. </p>
...
Where we need to collect personal data by law, or under the terms of a contract we have with you, and you fail to provide that data when requested, we may not be able to perform the contract we have or are trying to enter into with you (for example, to provide you with goods or services). In this case, we may have to cancel a product or service you have with us but we will notify you if this is the case at the time. 
                ...
                <ul>
                    <li><p><strong>Direct interactions.</strong> You may give us your Identity and Contact Data by filling in forms or by corresponding with us by post, phone, email or otherwise. This includes personal data you provide when you: 
</p></li>
                    <li><p>apply for our products or services; </p></li>
                    <li>request marketing to be sent to you; or </li>
                    <li><p>give us feedback or contact us.</p></li>
                    <li><p><strong>Automated technologies or interactions.</strong> As you interact with our website, we will automatically collect Technical Data about your equipment, browsing actions and patterns. We collect this personal data by using cookies, server logs and other similar technologies. Please see our <strong><Link to="">cookie policy</Link></strong> for further details. 
</p></li>
                </ul>
                <br />
<h3>
4. How we use your personal data
                ...
                <ul>
                    ...
                    <li><p>Where we need to comply with a legal obligation. <strong><Link>Click here</Link></strong> to find out more about the types of lawful basis that we will rely on to process your personal data. </p></li>
                </ul>
                <p>
...
We have set out below, in a table format, a description of all the ways we plan to use your personal data, and which of the legal bases we rely on to do so. We have also identified what our legitimate interests are where appropriate. 
      ...
      <thead>
        <tr style={{border:"1px solid rgba(128, 128, 128, 0.575)"}}>
          <th style={{border:"1px solid rgba(128, 128, 128, 0.575)"}}>Purpose</th>
          <th style={{border:"1px solid rgba(128, 128, 128, 0.575)"}}>Data Types</th>
          <th style={{border:"1px solid rgba(128, 128, 128, 0.575)"}}>Lawful Basis</th>
        </tr>
      </thead>
      <tbody>
        {data.map((item, index) => (
          <tr key={index} style={{border:"1px solid rgba(128, 128, 128, 0.575)"}}>
            <td  style={{border:"1px solid rgba(128, 128, 128, 0.575)"}}>{item.purpose}</td>
            <td  style={{border:"1px solid rgba(128, 128, 128, 0.575)"}}>{item.dataTypes.join(', ')}</td>
            <td  style={{border:"1px solid rgba(128, 128, 128, 0.575)"}}>{item.lawfulBasis.join(', ')}</td>
          </tr>
        ))}
      </tbody>
    </table><br />
    ...
    <p>
    You can set your browser to refuse all or some browser cookies, or to alert you when websites set or access cookies. If you disable or refuse cookies, please note that some parts of this website may become inaccessible or not function properly. For more information about the cookies we use,<strong><Link> please see </Link></strong>
...
If we need to use your personal data for an unrelated purpose, we will notify you and we will explain the legal basis which allows us to do so. 
   ...
   <ul>
    <li> We will only transfer your personal data to countries that have been deemed to provide an adequate level of protection for personal data. 
   ...
   <br />
    ...
    <ul>
        <li>Dental practices in the United Kingdom acting as controllers, for the purposes of dentists contacting you to discuss treatment options, following your specific request for them to do so via our website. </li>
        <li>Service providers acting as processors such as Cloudways Limited in Malta who provide website hosting, IT and system administration services. </li>
