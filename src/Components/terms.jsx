          ...
          <div className="terms-main">
            ...
            <p>
                    ...
                    What's in these terms?
                                    ...
                                    <p>
                                    These terms tell you the rules for using our website <Link to="http://www.nomadnurse.co.uk/">www.nomadnurse.co.uk</Link> (our site). 
                                    </p>
                                    <h4>
                        ...
                        <li>We are not responsible for viruses and you must not introduce them.</li>
                    ...
                    <p>
                    <Link to="http://www.nomadnurse.co.uk/">www.nomadnurse.co.uk</Link> is a site operated by Nomad Locum Limited ("We"). 
                    </p>
                    <p>
                    We are registered in England and Wales under company number 08133178 and have our registered office at {"{TBC}"}. Our main trading address is {"{TBC}"}. Our VAT number is{"{TBC}"}. 
                    ...
                    <ul>
                        <li>Our <strong><Link to="/privacy">Privacy Policy</Link></strong> . See further under How we may use your personal information. </li>
                        <li> Our <strong><Link to="/privacy">Privacy Policy</Link></strong>, which sets out information about the cookies on our site. 
                    </li>
                    </ul>
                    <h4>
                    ...
                    <p>
                    If you know or suspect that anyone other than you knows your user identification code or password, you must promptly notify us at info@smilefast.com.
                    </p>
                    <h4>
                    ...
                    <h4>Do not rely on information on this site
                    </h4>
                    <p>
                    ...
                    <p>
                    We will only use your personal information as set out in our <strong><Link to="/privacy">Privacy Policy</Link></strong>. 
                    </p>
                    <p>
